	...
	<section class="align-center flex-col form-card">
		...
		<sf:form action="add_donation" class="align-center flex-col form"
			...
			<div class="flex">
				...
				<div class="input-group">
					<sf:input required="true" type="text" name="amount"
						autocomplete="off" path="amount" class="input"
						id="donation-amount" />
					<label class="user-label">Donation Amount</label>
				</div>
			</div>
			<div class="input-group">
				<sf:input required="true" type="text" name="contact"
					autocomplete="off" path="contact" class="input" />
				<label class="user-label">Contact No.</label>
			</div>
			<div class="input-group">
				<sf:input required="true" type="text" name="accDetails"
					autocomplete="off" path="accDetails" class="input" />
				<label class="user-label">Account Details</label>
			</div>
