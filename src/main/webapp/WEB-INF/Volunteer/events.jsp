...
<jsp:include page="../header.jsp">
	<jsp:param value="Events" name="HTMLtitle" />
</jsp:include>
...
<main class="bg3 align-center justify-center">
	...
	<section class="align-center flex-col form-card">
		...
		<sf:form class="align-center flex-col form" action="post-events"
			...
			<div class="input-group">
			<sf:input required="true" type="date" name="date" autocomplete="off"
					path="date" class="input" onfocus="(this.type='date')" onblur="if(!this.value)this.type='text'"/>
