    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.GET, "/paypal").hasAnyRole("Donator")
                    .antMatchers(HttpMethod.POST, "/pay").hasAnyRole("Donator")
                    .antMatchers(HttpMethod.GET, "/order").hasAnyRole("Member")
                    .antMatchers(HttpMethod.GET, "/order-confirmation").hasAnyRole("Member")
                    .antMatchers(HttpMethod.GET, "/ongoing-orders").hasAnyRole("Member")
                .and()
                .logout()
