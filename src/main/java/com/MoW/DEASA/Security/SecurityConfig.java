    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.GET, "/dashboard").hasAnyRole("Administrator", "Volunteer", "Member", "Partner", "Donator", "Caregiver", "Driver")
                    .antMatchers(HttpMethod.GET, "/profile").hasAnyRole("Administrator", "Volunteer", "Member", "Partner", "Donator", "Caregiver", "Driver")
